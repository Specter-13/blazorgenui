namespace BlazorGenUI.Reflection.Models
{
    public class DetailTemplateModel
    {
        ...
        public string ItemNextToImage2Label { get; set; }
        public string ItemNextToImage2 { get; set; }

        public string ItemNextToImage3Label { get; set; }
        public string ItemNextToImage3 { get; set; }
        ...
        public string ItemBelowImage2Label { get; set; }
