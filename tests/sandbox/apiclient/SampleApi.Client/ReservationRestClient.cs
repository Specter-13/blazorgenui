...
{
    internal partial class ReservationRestClient
    {
        private Uri endpoint;
        private ClientDiagnostics _clientDiagnostics;
        private HttpPipeline _pipeline;

        /// <summary> Initializes a new instance of ReservationRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        public ReservationRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
        ...
        internal HttpMessage CreateGetAllRequest()
        {
            ...
            uri.Reset(endpoint);
            uri.AppendPath("/api/Reservation", false);
            request.Uri = uri;
        ...
        internal HttpMessage CreateCreateRequest(ReservationCreateUpdate body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<Stream>> CreateAsync(ReservationCreateUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public Response<Stream> Create(ReservationCreateUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        internal HttpMessage CreateUpdateRequest(ReservationCreateUpdate body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public async Task<Response<Stream>> UpdateAsync(ReservationCreateUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public Response<Stream> Update(ReservationCreateUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
